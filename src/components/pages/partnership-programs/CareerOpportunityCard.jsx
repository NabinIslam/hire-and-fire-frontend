const CareerOpportunityCard = ({ icon, title, description }) => {
  return (
    <div className="group space-y-2 rounded-lg border border-b-8 border-primary border-b-primary px-8 py-4 shadow-lg duration-200 hover:border-secondary hover:border-b-secondary">
