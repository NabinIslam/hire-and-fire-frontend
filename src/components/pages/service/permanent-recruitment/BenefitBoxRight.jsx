...
const BenefitBoxRight = ({ title, description, icon }) => {
  return (
    <FadeInDownWithSlowBounce className="benefit-box relative flex flex-row-reverse items-center gap-4 rounded-lg border border-l-8 border-r-8 border-l-secondary border-r-secondary px-5 py-7 shadow-lg">
