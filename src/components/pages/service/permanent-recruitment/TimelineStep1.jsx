    ...
    <div className="flex h-[220px] items-center justify-between">
      <div className="basis-full lg:basis-[45%]">
        <motion.div
          ...
          initial="hidden"
          animate={control}
          className="min-h-[183px] rounded-xl bg-none lg:bg-timeline-card-bg bg-contain bg-right bg-no-repeat lg:px-10 pb-7 pt-5"
        >
      ...
      <div className="hidden lg:basis-[45%] lg:block"></div>
    </div>
  );
};
