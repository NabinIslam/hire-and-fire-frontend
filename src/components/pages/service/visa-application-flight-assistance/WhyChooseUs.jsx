import { whyChooseUsForVisaApplicationFlightAssistance } from "@/data/whyChooseUsForVisaApplicationFlightAssistance";
import WorkPermitCard from "../work-permit-assistance/WorkPermitCard";
    ...
    <section className="pb-[100px] pt-[50px]">
      <div className="container space-y-8">
        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-12 lg:grid-cols-2 xl:grid-cols-3">
          {whyChooseUsForVisaApplicationFlightAssistance.map((cardData) => (
            <VisaApplicationCard cardData={cardData} key={cardData.id} />
          ))}
        </div>
      </div>
    </section>
