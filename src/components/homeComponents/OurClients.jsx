  ...
  return (
    <section className="py-[100px] space-y-[40px]">
      ...
      <div className="container">
        <Slider {...settings}>
          <div className="shadow-md rounded-lg h-[134px] flex items-center justify-center border px-10">
            <Image src={flexjobsLogo} alt="Flexjobs Logo" />
          </div>
          <div className="shadow-md rounded-lg h-[134px] flex items-center justify-center border px-10">
            <Image src={glassdoorLogo} alt="Flexjobs Logo" />
          </div>
          <div className="shadow-md rounded-lg h-[134px] flex items-center justify-center border px-10">
            <Image src={indeedLogo} alt="Flexjobs Logo" />
          </div>
          <div className="shadow-md rounded-lg h-[134px] flex items-center justify-center border px-10">
            <Image src={linkedinLogo} alt="Flexjobs Logo" />
          </div>
          <div className="shadow-md rounded-lg h-[134px] flex items-center justify-center border px-10">
            <Image src={upworkLogo} alt="Flexjobs Logo" />
          </div>
        </Slider>
      </div>
    </section>
